        ...
        <div class="card-body">
            ...
            <form method="POST" action="/register" class="space-y-4">
                ...
                <select name="securityQuestion2"
                    ...
                    <option value="" disabled selected>-- Choose a question --</option>
                    <option value="What was your first school called?" {{ old('securityQuestion2') == 'What was your first school called?' ? 'selected' : '' }}>What was your first school called?</option>
                    <option value="What is your favorite movie?" {{ old('securityQuestion2') == 'What is your favorite movie?' ? 'selected' : '' }}>What is your favorite movie?</option>
                    <option value="What was your childhood nickname?" {{ old('securityQuestion2') == 'What was your childhood nickname?' ? 'selected' : '' }}>What was your childhood nickname?</option>
                </select>
                ...
                <select name="securityQuestion3"
                    ...
                    <option value="" disabled selected>-- Choose a question --</option>
                    <option value="What was your dream job as a child?" {{ old('securityQuestion3') == 'What was your dream job as a child?' ? 'selected' : '' }}>What was your dream job as a child?</option>
                    <option value="What is your favorite food?" {{ old('securityQuestion3') == 'What is your favorite food?' ? 'selected' : '' }}>What is your favorite food?</option>
                    <option value="What is your favourite holiday destination?" {{ old('securityQuestion3') == 'What is your favourite holiday destination?' ? 'selected' : '' }}>What is your favourite holiday destination?</option>
                </select>
